...
function toggleDetailsContact() {
    document.getElementById("contentDetails").classList.toggle("active");
    document.getElementById("contactContent").classList.toggle("bgc-darkblue");
    document.getElementById("nameInList").classList.toggle("color-white");
    document.getElementById("nameCircle").classList.toggle("border-white");
}